...
def interleaved_sum(n, f_odd, f_even):
    ...
    True
    """
    def helper(k, n, f_odd, f_even):
        if k == n:
            return f_odd(k)
        elif k == n + 1:
            return 0
        else:
            return f_odd(k) + f_even(k + 1) + helper(k + 2, n, f_odd, f_even)
    return helper(1, n, f_odd, f_even)
...
def count_dollars(total):
    ...
    def helper(tt, maximum):
        ...
        if tt == 0:
            ...
            return helper(tt - maximum, maximum) + helper(tt, next_smaller_dollar(maximum))
...
def shuffle(s):
    ...
    for i in range(len(s) // 2):
        ...
        shuffled_list.append(s[i + len(s) // 2])
